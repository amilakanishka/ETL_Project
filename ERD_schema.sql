...
ALTER TABLE "HealthExpenditure" ADD CONSTRAINT "fk_HealthExpenditure_id" FOREIGN KEY("id")
REFERENCES "Country" ("id");

ALTER TABLE "Covid_Counts" ADD CONSTRAINT "fk_Covid_Counts_id" FOREIGN KEY("id")
REFERENCES "Country" ("id");

ALTER TABLE "Population" ADD CONSTRAINT "fk_Population_id" FOREIGN KEY("id")
REFERENCES "Country" ("id");
